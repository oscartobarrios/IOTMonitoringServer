...
ALLOWED_HOSTS = ["localhost", "18.234.94.179","107.21.73.31","54.83.139.42","3.80.255.45","52.55.106.58"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "54.80.244.138",  # Dirección IP de la base de datos
...
MQTT_USER = "pruebas"
MQTT_PASSWORD = "Santiago2001."

# Credenciales para el usuario publicador del bróker MQTT
MQTT_USER_PUB = "pruebas"
MQTT_PASSWORD_PUB = "Santiago2001."
