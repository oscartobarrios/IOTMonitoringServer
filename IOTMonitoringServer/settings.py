...
ALLOWED_HOSTS = ["localhost", "18.234.243.101","52.90.181.22","3.80.174.110","34.229.212.191","54.196.70.116"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "18.208.229.18",  # Dirección IP de la base de datos
